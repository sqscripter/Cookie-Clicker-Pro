...
function showAllUpgrades() {
  if (opacityScale == 0) {
    ...
    LegendCutterbtn.style.opacity = 0;
    GodTLaserbtn.style.opacity = 0;
    ...
    LegendCutterbtn.style.pointerEvents = "none";
    GodTLaserbtn.style.pointerEvents = "none";
...
function devtools() {
  opendev()
  console.log('devtools by daxcodes. dont tell sqcodes.')
}